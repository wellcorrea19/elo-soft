                        ...
                        <div class="card-body table-responsive">
                            <ul class="vertical-nav-menu" id="css-table">
                                <li style="border-bottom: 0.1px solid rgb(218, 218, 218)">
                                    ...
                                    <ul>
                                        <div>
                                            <button class=" btn-geral btn btn-primary" data-toggle="modal"
                                                    data-target="#modalInfoEmpresa"><i class="fas fa-archive"
                                                                                       style="position: absolute; top: 7px; left: 6px;"></i>
                                            </button>
                                            <button class="btn-geral btn btn-success" data-toggle="modal"
                                                    data-target="#modalUsuario"><i class="fas fa-plus"
                                                                                   style="position: absolute; top: 7px; left: 7px;"></i>
                                            </button>
                                            <button class="btn-geral btn btn-danger"><i class="fas fa-ban"
                                                                                        style="position: absolute; top: 7px; left: 6px;"></i>
                                            </button>
                                        </div>
                                        <li>
